...
New-Item __tempdir -ItemType Directory

foreach ($app in $apps) {
    New-Item __tempdir\$app -ItemType Directory
}
...
foreach ($app in $apps) {
    foreach ($runtime in $runtimes) {
        ...
        Move-Item .\source-codes\$app\bin .\__tempdir\$app\bin
        Move-Item .\source-codes\$app\obj .\__tempdir\$app\obj
    }
}
